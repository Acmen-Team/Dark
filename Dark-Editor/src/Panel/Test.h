...
namespace ImGui {
  ...
  bool ButtonYxYEx(const ImVec4& cols, const ImVec2& size_arg, ImGuiButtonFlags flags, const char* fmt, ...)
  {
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
      return false;
    ...
    RenderTextClipped(bb.Min + style.FramePadding, bb.Max - style.FramePadding, fmt, NULL, &label_size, style.ButtonTextAlign, &bb);
